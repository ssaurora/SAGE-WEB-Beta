...
function WorkbenchObjectInspector({
  pickedFeature,
  sceneId,
...
function WorkbenchStateFocusCard({
  isInputFocusState,
...
function WorkbenchLayerControls({
  layers,
  groupedLayers,
  collapsedGroups,
  activeLayerName,
  ...
  const renderLayerRow = (
    ...
    >
      ...
      <div className="mt-2 flex gap-2">
        ...
        <Button size="sm" variant="secondary" onClick={() => onZoomToLayer(layer.name)}>
          Zoom to Layer
        </Button>
      </div>
